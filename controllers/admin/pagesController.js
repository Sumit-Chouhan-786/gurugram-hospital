const Page = require("../../models/pageModel"); // Ensure the correct path to your model
...
const addPageView = (req, res) => {
  ...
  res.render("admin-ui/addPage.ejs", { message });
};
...
const allPages = async (req, res) => {
  try {
    ...
    res.render("admin-ui/allPages.ejs", {
      pages,
...
const updatePageView = async (req, res) => {
  try {
    ...
    res.render("admin-ui/updatePage.ejs", { title: "Update Page", page:page });
  } catch (err) {
